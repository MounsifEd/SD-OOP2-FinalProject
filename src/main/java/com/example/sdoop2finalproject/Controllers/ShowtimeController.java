...
import com.example.sdoop2finalproject.Models.ShowtimeData;
...
public class ShowtimeController {
    ...
    public void loadShowtimes(Movie pMovie) {
        ...
        for (MovieShow show : ShowtimeData.getInstance()
            ...
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/sdoop2finalproject/showtime-card.fxml"));
